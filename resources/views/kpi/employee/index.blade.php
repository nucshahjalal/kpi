                                ...
                                <div class="row align-items-center mb-3 pb-2 border-bottom g-0" style="background: #fdfdfd; padding: 10px 15px; border-radius: 8px;">
                                    ...
                                    <div class="col-md-6 ps-3">
                                        <h5 class="text-primary font-weight-bold mb-1">
                                            {{ $obj->full_name }} ({{ $obj->staff_id }})<span class="text-muted fw-normal" style="font-size: 0.8rem;"></span>
                                        </h5>
                                        <p class="text-muted mb-1 small text-truncate">{{ $obj->designation }}</p>
                                        <p class="text-muted mb-0 fw-bold small">
                                            Supervisor: {{ $obj->supervisor_name }} ({{ $obj->supervisor_id }})
                                        </p>
                                    </div>
...
<script type="text/javascript">
    ...
    document.getElementById('download_excel').addEventListener('click', function(e) {
        ...
        var url = "{{ url('kpi/employee-export') }}" + "?from_date=" + encodeURIComponent(fromDate) + "&to_date=" + encodeURIComponent(toDate);
