@extends('backend.app')
@section('page_title','Inquiry Warm List')
@section('content')
    ...
    <div class="page-header d-flex align-items-center justify-content-between">
        ...
        <div class="page-header-left d-flex align-items-center gap-2">
            <div class="page-header-right ms-auto">
                <form method="get" action="{{ url('inquiry-warm/list') }}" id="submitForm" class="d-flex align-items-center gap-2">
                    @csrf
...
<script type="text/javascript">
    ...
    document.getElementById('download_pdf').addEventListener('click', function(e) {
        ...
        var url = "{{ url('inquiry-warm/download-pdf') }}" + "?from_date=" + encodeURIComponent(fromDate) + "&to_date=" + encodeURIComponent(toDate);
    ...
    document.getElementById('download_excel').addEventListener('click', function(e) {
        ...
        var url = "{{ url('inquiry-warm/export') }}" + "?from_date=" + encodeURIComponent(fromDate) + "&to_date=" + encodeURIComponent(toDate);
