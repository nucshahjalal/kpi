...
<script type="text/javascript">
    ...
    document.getElementById('download_pdf').addEventListener('click', function(e) {
        ...
        var url = "{{ url('inquiry-hot/download-pdf') }}" + "?from_date=" + encodeURIComponent(fromDate) + "&to_date=" + encodeURIComponent(toDate);
    ...
    document.getElementById('download_excel').addEventListener('click', function(e) {
        ...
        var url = "{{ url('inquiry-hot/export') }}" + "?from_date=" + encodeURIComponent(fromDate) + "&to_date=" + encodeURIComponent(toDate);
