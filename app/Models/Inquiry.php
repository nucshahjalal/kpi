...
class Inquiry extends Model
{
    ...
    public static function getWarmList( $from_date = null, $to_date = null)
    {
        ...
        $inquiries = $inquiries->orderBy('I.id', 'desc')->paginate(10, ['I.*']);
        return $inquiries;
    }

    public static function getColdList( $from_date = null, $to_date = null)
    {
        $inquiries = Inquiry::from('inquiries as I')
        ->where('I.status', 2)
        ->orderBy('I.id','desc');
    ...
    public static function getHotList( $from_date = null, $to_date = null)
    {
        $inquiries = Inquiry::from('inquiries as I')
        ->where('I.status', 0);
